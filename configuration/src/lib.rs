...
// 1. try to load from user specified location - use command line interface
// 2. if nothing specified us default configuration
// 3. this means we try to load service account from default location
